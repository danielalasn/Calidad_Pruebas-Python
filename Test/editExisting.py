...
class Add(unittest.TestCase):
    ...
    def test_edit(self):
        ...
        driver.find_element(By.NAME, "email").clear()
        driver.find_element(By.NAME, "email").send_keys("alumno1@gmail.com")
        driver.find_element(By.NAME, "age").click()
        driver.find_element(By.NAME, "age").clear()
        ...
        message = driver.find_element(By.XPATH,
                                      "/html/body/div[2]/div/div[2]/form/div[5]/div/p").text
        self.assertEqual("That email is already taken.", message)
